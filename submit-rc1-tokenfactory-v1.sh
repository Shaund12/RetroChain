...
# Required inputs
UPGRADE_HEIGHT_JSON="${UPGRADE_HEIGHT_JSON:-/home/shaun/retrochain-rc1/contracts/ra/deploy/proposal_upgrade_rc1_tokenfactory_v1.json}"
...
echo "Submitting tokenfactory upgrade proposal from $FROM ($CHAIN_ID @ $NODE)..."
