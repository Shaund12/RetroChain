...
import { QueryParamsResponse } from "./types/retrochain/arcade/v1/query";

import { QueryParamsRequest } from "./types/retrochain/arcade/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/retrochain/arcade/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/retrochain/arcade/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
