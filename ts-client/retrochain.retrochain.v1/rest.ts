...
import { QueryParamsResponse } from "./types/retrochain/retrochain/v1/query";

import { QueryParamsRequest } from "./types/retrochain/retrochain/v1/query";
...
/**
 * @title retrochain.retrochain.v1
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/retrochain/retrochain/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/retrochain/retrochain/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
